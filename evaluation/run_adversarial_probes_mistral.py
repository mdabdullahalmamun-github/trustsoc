...
def main():
    ...
    results = []
    for p in probes:
        answer = trustsoc_answer(p["question"], model="mistral", k=5)
    ...
    results_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "adversarial_probes_results_mistral.json")
