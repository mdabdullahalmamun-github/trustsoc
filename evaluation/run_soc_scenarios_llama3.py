...
def main():
    ...
    results = []
    for s in scenarios:
        answer = trustsoc_answer(s["question"], model="llama3", k=5)
    ...
    results_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "soc_scenarios_results_llama3.json")
